      ...
      child: ListTile(
        ...
        trailing: DropdownButton<Locale>(
          ...
          items:
              locales.map((locale) {
                final name =
                    names.nameOf(locale.toLanguageTag()) ??
...
class TimeFormatSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final patterns = SettingsProvider.availableTimeFormats.map(
      (pattern) => DateFormat(pattern, locale),
    );
    ...
    return OptionsChooserTile(
      ...
      values: patterns.map((pattern) {
        return Option(value: pattern.pattern, text: pattern.format(date));
      }),
      onChanged: (v) {
...
class ImmersiveModeTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CheckboxListTile.adaptive(
      ...
      onChanged:
          settings.kFullscreen.value || isMobilePlatform
              ? (v) {
              ...
              DataCell(
                ...
                onTap: () {
                  showDialog(
                    context: context,
                    builder:
                        (context) => KeybindingDialog(keybinding: keybinding),
                  );
                },
              ),
            ],
